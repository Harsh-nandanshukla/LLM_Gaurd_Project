...
results_df.to_csv(
    "results/results_presidio_new.csv",
    index=False,
)
...
metrics_df.to_csv(
    "results/metrics_presidio_new.csv",
    index=False,
)
...
print()
print("Saved:")
print("results/results_presidio_new.csv")
print("results/metrics_presidio_new.csv")
